...
//                ARouter.printStackTrace();
        } else if (id == R.id.openDebug) {
            ARouter.openDebug();
        } else if (id == R.id.init) {// 调试模式不是必须开启，但是为了防止有用户开启了InstantRun，但是
        ...
        } else if (id == R.id.normalNavigation) {
            ARouter.getInstance()
        ...
        } else if (id == R.id.kotlinNavigation) {
            ARouter.getInstance()
                    .build("/kotlin/test")
                    .withString("name", "老王")
                    .withInt("age", 23)
            ...
            ARouter.getInstance().build("/test/activity1")
                    ...
                    .withObject("map", map)
                    .navigation();
        } else if (id == R.id.navByName) {
            ((HelloService) ARouter.getInstance().build("/yourservicegroupname/hello").navigation()).sayHello("mike");
        } else if (id == R.id.navByType) {
            ARouter.getInstance().navigation(HelloService.class).sayHello("mike");
        } else if (id == R.id.navToMoudle1) {
            ARouter.getInstance().build("/module/1").navigation();
        } else if (id == R.id.navToMoudle2) {// 这个页面主动指定了Group名
        ...
        } else if (id == R.id.normalNavigation2) {
            ARouter.getInstance()
                    .build("/test/activity2")
                    .navigation(this, 666);
        } else if (id == R.id.getFragment) {
        ...
        } else if (id == R.id.dynamicNavigation) {// 该页面未配置 Route 注解，动态注册到 ARouter
